  ...
  <v-row style="margin-top: -64px">
    ...
    <v-col cols="12">
      <v-card class="mx-auto">
        <v-card-subtitle>Device-Sidomulyp</v-card-subtitle>
        <arusip
      ...
      <v-card class="mx-auto">
        ...
        <v-card-text>
          <p class="text-justify">
            Desa Sidomulyo Kode Desa: 34025201 Kepala Desa: Edi Murjita, S.Pd
            Alamat Balai Desa: Sidomulyo, Bambanglipuro Koordinat: -7.956653,
            110.305079 Kode Pos: 55764 Telepon: E-mail:
            desa.sidomulyo@bantulkab.go.id Situs web:
            http://sidomulyo-bantul.desa.id Pedukuhan Ngajaran Cangkring Palihan
            Sirat Ngireng-ireng Tempel Prenggan Selo Plematung Plebengan Ponggok
            Pinggir Turi Glodogan Kuwon Profil Desa Desa Sidomulyo Desa
            Sidomulyo merupakan desa yang terletak secara administratif di
            Kecamatan Bambanglipuro Bantul. Desa ini merupakan Desa yang berada
            di jantung Kecamatan Bambanglipuro. Desa Sidomulyo memiliki potensi
            besar terutama sebagi eksisting pengembangan kawasan perkotaan
            karena memiliki daerah strategis. Di Desa Sidomulyo hampir seluruh
            kantor instansi pemerintah Kecamatan Bambanglipuro berada di wilayah
            ini. Kantor Instansi Pemerintah yang berada di level Kecamatan
            berada di wilayah adminstrasi Desa Sidomulyo yang terdiri atas
            Puskesmas Bambanglipuro, SMP N 2 Bambanglipuro dan Kantor Kecamatan
            Bambanglipuro.
          </p>
        </v-card-text>
      </v-card>
    ...
    <v-col cols="12" sm="6" md="4">
      <v-col>
        <v-card class="mx-auto">
          ...
          <v-img height="150" :src="require('../assets/sudimulyo.jpg')">
          </v-img>
        </v-card>
      </v-col>
      <v-col>
